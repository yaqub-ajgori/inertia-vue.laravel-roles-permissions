    ...
    <AuthenticatedLayout>
        <template #header>
            <div class="flex justify-between">
             <h2 class="font-semibold text-xl text-gray-800 leading-tight">All permission</h2>
             <Link
                        ...
                        <Table>
                            ...
                            <template #default>
                                <TableRow v-for="permission in permissions" :key="permission.id" class="border-b">
                                    ...
                                    <TableDataCell>{{ permission.created_at }}</TableDataCell>
                                    <TableDataCell class="flex space-x-2">
                                        ...
                                        <Link method="DELETE" as="button" :href="route('permissions.destroy', permission.id)" class="px-5 py-2 bg-red-600 hover:bg-red-800 text-white shadow-sm rounded-lg text-sm">Delete</Link>
                                    </TableDataCell>
                                </TableRow>
                            </template>
                        </Table>
